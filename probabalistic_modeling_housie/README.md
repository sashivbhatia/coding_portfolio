...
---
## 🎞️ GIF Generator (`tambola_gif.py`)  
A standalone script that sweeps through player counts 1–50, running 1,000 simulations for each, and exports an animated GIF (`tambola_distribution.gif`) showing how the first-house distribution shifts as more players are added. Run with `pip install matplotlib numpy pillow` then `python tambola_gif.py`.  
